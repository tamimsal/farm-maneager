// ESP32 Smart Farm firmware: Wi‑Fi + WebSocket server broadcasting JSON sensor data
// Features: WebSocket remote pump control via dashboard
...
// Built-in SoftAP so you can connect even if your router isolates clients
const char* AP_SSID = "FARM-ESP32";
const char* AP_PASSWORD = "farm1234"; // min 8 chars for WPA2
...
void connectWifi() {
  ...
  if (WiFi.status() == WL_CONNECTED) {
    ...
    Serial.println("\nWi‑Fi STA connect timeout; AP mode available as fallback");
  }
}
